...
nMediaFaltasDisciplina1  := 0
nMediaFaltasDisciplina2  := 0
nMediaFaltasDisciplina3  := 0
...
nMediaFaltasDisciplina1 = (nFaltasDisciplina1Bimestre1 + nFaltasDisciplina1Bimestre2 + nFaltasDisciplina1Bimestre3 + nFaltasDisciplina1Bimestre4) / 4

if nMediaDisciplina1 < nMedia
    cCorMediaDisciplina1 = "r/n"
endif

if nMediaFaltasDisciplina1 > nFaltasParaReprovar
    cCorFaltasTotaisDisciplina1 := "r/n"
endif

if nMediaFaltasDisciplina1 > nFaltasParaReprovar .or. nMediaDisciplina1 < nMedia
    nResultadoDisciplina1 := "DP"
    nDependencias += 1
    cDependencias += ", " + cNomeDisciplina1
...
@ 10,62 say nMediaFaltasDisciplina1          picture "99"        color cCorFaltasTotaisDisciplina1
...
nMediaFaltasDisciplina2 = (nFaltasDisciplina2Bimestre1 + nFaltasDisciplina2Bimestre2 + nFaltasDisciplina2Bimestre3 + nFaltasDisciplina2Bimestre4) / 4

if nMediaDisciplina2 < nMedia
    cCorMediaDisciplina2 = "r/n"
endif

if nMediaFaltasDisciplina2 > nFaltasParaReprovar
    cCorFaltasTotaisDisciplina2 := "r/n"
endif

if nMediaFaltasDisciplina2 > nFaltasParaReprovar .or. nMediaDisciplina2 < nMedia
    nResultadoDisciplina2 := "DP"
    nDependencias += 1
    cDependencias += ", " + cNomeDisciplina2
...
@ 12,62 say nMediaFaltasDisciplina2          picture "99"        color cCorFaltasTotaisDisciplina2
...
nMediaFaltasDisciplina3 = (nFaltasDisciplina3Bimestre1 + nFaltasDisciplina3Bimestre2 + nFaltasDisciplina3Bimestre3 + nFaltasDisciplina3Bimestre4) / 4

if nMediaDisciplina3 < nMedia
    cCorMediaDisciplina3 = "r/n"
endif

if nMediaFaltasDisciplina3 > nFaltasParaReprovar
    cCorFaltasTotaisDisciplina3 := "r/n"
endif

if nMediaFaltasDisciplina3 > nFaltasParaReprovar .or. nMediaDisciplina3 < nMedia
    nResultadoDisciplina3 := "DP"
    nDependencias += 1
    cDependencias += ", " + cNomeDisciplina3
...
@ 14,62 say nMediaFaltasDisciplina3          picture "99"        color cCorFaltasTotaisDisciplina3
