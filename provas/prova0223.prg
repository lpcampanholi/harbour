...
nValorFinalSeguradora1 = (nValorBaseSeguradora2 * nPorcetagemAumentoSeguradora1)
...
nValorFinalSeguradora2 = (nValorBaseSeguradora2 * nPorcetagemAumentoSeguradora2)
...
@ 04,01 say "_________________________________"
@ 05,01 say "Mensal......: " + AllTrim(Str(nValorFinalSeguradora1 / 12, 2))
@ 06,01 say "Trimestral..: " + AllTrim(Str(nValorFinalSeguradora1 / 3, 2))
@ 07,01 say "Anual.......: " + AllTrim(Str(nValorFinalSeguradora1))

@ 02,37 to 08,71 color cCorSeguradora2
@ 03,37 say "AUTO SEGUROS SA"
@ 04,37 say "_________________________________"
@ 05,37 say "Mensal......: " + AllTrim(Str(nValorFinalSeguradora2 / 12, 2))
@ 06,37 say "Trimestral..: " + AllTrim(Str(nValorFinalSeguradora2 / 3, 2))
@ 07,37 say "Anual.......: " + AllTrim(Str(nValorFinalSeguradora2))
...
dPrimeiroDiaProximoMes := CtoD("01/" + StrZero(nProximoMes, 2)) + "/" + AllTrim(Str(nProximoAno))
dUltimoDiaMes := dPrimeiroDiaProximoMes - 1

@ 10,01 say "Cotacao valida ate " + DtoC(Day(dUltimoDiaMes)) + " de " + AllTrim(cMes) + " de " + AllTrim(Str(nAno))
